...
public class DKPermsPermissionObjectCreateEvent implements PermissionObjectEvent {

    private final PermissionObject executor;
    private final PermissionObject object;

    public DKPermsPermissionObjectCreateEvent(PermissionObject executor, PermissionObject object) {

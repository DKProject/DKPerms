...
public class DefaultAuditLog implements AuditLog {
    ...
    @Override
    public void createRecord(PermissionObject executor, LogType type, LogAction action, PermissionObject owner, Object key, String field, Object oldValue, Object newValue, Object data) {
       /*
